...
from fas_simple_distill.model.resnet_ssdg.ssdg_resnet_baseline_no_relu import DG_model
...
class LivenessModel:
    def __init__(
        ...
        self.noise = ssdg_normalize(torch.randn((1, 512), device="cuda"))
...
def _main():
    ...
    embedding_folder = "ssdg_baseline_no_relu_noise_OMItoC_remove_fr_feature_norm"
