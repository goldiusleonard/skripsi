...
from fas_simple_distill.model.resnet_ssdg.ssdg_resnet_baseline_noise_generator import (
    DG_model_noise,
)
...
def _main():
    ...
    liveness_model = LivenessModel(
        "evaluator/weights/ssdg_noise_generator_feat_mining_OMItoC.pth"
    )
    embedding_folder = "ssdg_noise_generator_feat_mining_OMItoC"
