...
def _main():
    ...
    liveness_model = LivenessModel(
        "evaluator/weights/resnet_feature_mine_baseline_attack_discriminator_fixed.pth"
    )
    embedding_folder = "resnet_feature_mine_baseline_attack_discriminator_fixed_OMItoC"
