...
class Classifier(nn.Module):
    ...
    def forward(self, inp, norm_flag):
        if norm_flag:
            self.classifier_layer_1.weight.data = l2_norm(
                self.classifier_layer_1.weight, axis=0
            )
            self.classifier_layer_2.weight.data = l2_norm(
                self.classifier_layer_2.weight, axis=0
            )
