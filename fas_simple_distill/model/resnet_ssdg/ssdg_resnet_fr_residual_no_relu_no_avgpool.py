...
class Classifier(nn.Module):
    def __init__(self, embedding_size=512):
        ...
        self.classifier_layer = nn.Linear(embedding_size, 2)
...
class DG_model(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.classifier = Classifier(embedding_size=embedding_size // 2)
        self.norm_flag = norm_flag
    ...
    def forward(self, x):
        ...
        classifier_out = self.classifier(
            feat_for_classif[:, self.embedding_size // 2 :], self.norm_flag
        )
