...
class WBEmulator:
  def __init__(self):
    ...
    self.features = np.load('/opt/ml/code/fas_simple_distill/data/webdatasets/params/features.npy')
    # mapping functions to emulate WB effects
    self.mappingFuncs = np.load('/opt/ml/code/fas_simple_distill/data/webdatasets/params/mappingFuncs.npy')
    # weight matrix for histogram encoding
    self.encoderWeights = np.load('/opt/ml/code/fas_simple_distill/data/webdatasets/params/encoderWeights.npy')
    # bias vector for histogram encoding
    self.encoderBias = np.load('/opt/ml/code/fas_simple_distill/data/webdatasets/params/encoderBias.npy')
    ...
    #                            '_D_AS', '_D_CS']
    self.wb_photo_finishing = ['_F_CS', '_S_CS',
                               '_T_CS', '_C_CS',
                                '_D_CS']
